  ...
  <div class="login-wrapper">
    <div class="login-box">
      ...
      >
        ...
        <el-form-item>
          <template>
            <el-radio v-model="radio" label="1" @change="getType('1')"
              >管理员</el-radio
            >
            <el-radio v-model="radio" label="2" @change="getType('2')"
              >老师</el-radio
            >
            <el-radio v-model="radio" label="3" @change="getType('3')"
              >学生</el-radio
            >
          </template>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getType(userType) {
      ...
      if(userType == "1"){
        // 设置默认管理员账号密码
        this.adminLoginForm.username = "10011";
        this.adminLoginForm.password = "123456";
      } else if(userType == "2"){
        // 设置默认教师账号密码
        this.adminLoginForm.username = "10052";
        this.adminLoginForm.password = "123456";
      } else if(userType == "3"){
        // 设置默认学生账号密码
        this.adminLoginForm.username = "2022013155";
        this.adminLoginForm.password = "Chq.5247L247";
      }
    },
